...
$ProfilesPath = "\\sagwcavd002prof001.file.core.windows.net\fslogix1\profc\w11-2h"
...
# Reboot to enable the configuration changes, because restart of ephemeral vms is not possible in Azure
