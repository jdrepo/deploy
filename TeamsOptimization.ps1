...
# $VCRedistributableLink = https://aka.ms/vc14/vc_redist.x64.exe
# $WebRTCInstaller = https://aka.ms/msrdcwebrtcsvc/msi
# 
# .\TeamsOptimization.ps1 -VCRedistributableLink https://aka.ms/vc14/vc_redist.x64.exe -WebRTCInstaller https://aka.ms/msrdcwebrtcsvc/msi -TeamsBootStrapperUrl https://go.microsoft.com/fwlink/?linkid=2243204
